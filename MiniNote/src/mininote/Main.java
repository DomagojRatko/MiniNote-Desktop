...
public class Main {
    ...
    public static void main(String[] args) {
        Runnable runnable = () -> {
            ...
            ImageIcon exitImg = new ImageIcon(new ImageIcon("src/images/exitPic.png").getImage().getScaledInstance(30, 30, Image.SCALE_DEFAULT));
            ImageIcon lineImg = new ImageIcon(new ImageIcon("src/images/linePic.png").getImage().getScaledInstance(300, 5, Image.SCALE_DEFAULT));
            ImageIcon minImg = new ImageIcon(new ImageIcon("src/images/minPic.png").getImage().getScaledInstance(30, 30, Image.SCALE_DEFAULT));
